...
public class visual extends JFrame implements ActionListener {
    ...
    private void Panel() {
        ...
        panel = new JLabel(new ImageIcon("src/main/java/pictures/ffon.png"));
        ...
        if (usuario.getText().equals("Nick name")||usuario.getText().equals("")) {
            ...
            if (clic.equals(uno)) {
                ...
                int x = JOptionPane.showOptionDialog(null, "Escoja la dificultad", "Dificultad",
                        JOptionPane.OK_CANCEL_OPTION, JOptionPane.INFORMATION_MESSAGE, new ImageIcon("src/main/java/pictures/dif.png"), d
                        , "Option");
                this.dispose();
